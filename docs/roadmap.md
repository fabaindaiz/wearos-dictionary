...
pipeline de packs (`tools/`, **355 tests**) están completos y en el gate, junto con los **304 JVM
de `:app`** y **26 checks** de auditoría estructural — **787 tests en total**. Los **46
