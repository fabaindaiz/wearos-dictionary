...
pipeline de packs (`tools/`, **351 tests**) están completos y en el gate, junto con los **294 JVM
de `:app`** y **26 checks** de auditoría estructural — **768 tests en total**. Los **44
