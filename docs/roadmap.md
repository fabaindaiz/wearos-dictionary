...
pipeline de packs (`tools/`, **494 tests**) están completos y en el gate, junto con los **411 JVM
de `:app`** y **32 checks** de auditoría estructural — **1064 tests en total**. Los **46
