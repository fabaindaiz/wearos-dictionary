...
pipeline de packs (`tools/`, **480 tests**) están completos y en el gate, junto con los **409 JVM
de `:app`** y **31 checks** de auditoría estructural — **1042 tests en total**. Los **46
