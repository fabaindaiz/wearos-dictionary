...
pipeline de packs (`tools/`, **480 tests**) están completos y en el gate, junto con los **395 JVM
de `:app`** y **30 checks** de auditoría estructural — **1027 tests en total**. Los **46
