...
pipeline de packs (`tools/`, **480 tests**) están completos y en el gate, junto con los **398 JVM
de `:app`** y **31 checks** de auditoría estructural — **1031 tests en total**. Los **46
