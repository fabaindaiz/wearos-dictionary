...
pipeline de packs (`tools/`, **480 tests**) están completos y en el gate, junto con los **374 JVM
de `:app`** y **29 checks** de auditoría estructural — **1005 tests en total**. Los **46
