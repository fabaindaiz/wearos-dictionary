...
pipeline de packs (`tools/`, **559 tests**) están completos y en el gate, junto con los **442 JVM
de `:app`** y **40 checks** de auditoría estructural — **1174 tests en total**. Los **48
