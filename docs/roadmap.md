...
pipeline de packs (`tools/`, **323 tests**) están completos y en el gate, junto con los **289 JVM
de `:app`** y **26 checks** de auditoría estructural — **729 tests en total**. Los **43
