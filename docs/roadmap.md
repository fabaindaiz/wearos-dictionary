...
pipeline de packs (`tools/`, **378 tests**) están completos y en el gate, junto con los **360 JVM
de `:app`** y **26 checks** de auditoría estructural — **866 tests en total**. Los **46
