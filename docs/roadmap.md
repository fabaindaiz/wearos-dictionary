...
pipeline de packs (`tools/`, **378 tests**) están completos y en el gate, junto con los **304 JVM
de `:app`** y **26 checks** de auditoría estructural — **810 tests en total**. Los **46
