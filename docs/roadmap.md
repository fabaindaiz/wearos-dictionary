...
pipeline de packs (`tools/`, **545 tests**) están completos y en el gate, junto con los **441 JVM
de `:app`** y **40 checks** de auditoría estructural — **1159 tests en total**. Los **48
