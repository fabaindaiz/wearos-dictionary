...
Corre compilación, Android Lint, los **47 de `:dict-core`**, los **154 JVM de `:app`** (las pantallas incluidas, con Robolectric), los
**101 del builder Python** y la auditoría estructural (**19 checks**).
